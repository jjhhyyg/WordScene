...
grep -qF '5. Use scripts/manual_smoke_session_guide.sh to print the preflight, install command, checklist pointer, and record-command templates in one place.' "$TMPDIR/actions.out"
