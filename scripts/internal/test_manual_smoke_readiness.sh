...
"$ROOT/scripts/internal/manual_smoke_readiness.sh" --evidence "$EVIDENCE" >"$TMPDIR/readiness.out"
...
"$ROOT/scripts/internal/manual_smoke_readiness.sh" --evidence "$EVIDENCE" --commands >"$TMPDIR/commands.out"

grep -qF 'READY Translation loop / iPhone' "$TMPDIR/commands.out"
grep -qF 'scripts/internal/record_release_smoke_result.sh \' "$TMPDIR/commands.out"
...
"$ROOT/scripts/internal/manual_smoke_readiness.sh" --evidence "$EVIDENCE" --summary >"$TMPDIR/summary.out"
...
"$ROOT/scripts/internal/manual_smoke_readiness.sh" --evidence "$EVIDENCE" --commands --scope ios >"$TMPDIR/ios-commands.out"
...
"$ROOT/scripts/internal/manual_smoke_readiness.sh" --evidence "$EVIDENCE" --commands --scope ios-device >"$TMPDIR/ios-device-commands.out"
...
"$ROOT/scripts/internal/manual_smoke_readiness.sh" --evidence "$EVIDENCE" --commands --scope local-only >"$TMPDIR/local-only-commands.out"
...
"$ROOT/scripts/internal/manual_smoke_readiness.sh" --evidence "$EVIDENCE" --commands --scope macos >"$TMPDIR/macos-commands.out"
...
if grep -qF 'scripts/internal/record_release_smoke_result.sh \' "$TMPDIR/macos-commands.out"; then
...
"$ROOT/scripts/internal/manual_smoke_readiness.sh" --evidence "$EVIDENCE" --commands >"$TMPDIR/stale-candidate.out"
...
if grep -qF 'scripts/internal/record_release_smoke_result.sh \' "$TMPDIR/stale-candidate.out"; then
...
"$ROOT/scripts/internal/manual_smoke_readiness.sh" --evidence "$LIVE_STALE_EVIDENCE" --commands >"$TMPDIR/stale-live.out"
...
if grep -qF 'scripts/internal/record_release_smoke_result.sh \' "$TMPDIR/stale-live.out"; then
