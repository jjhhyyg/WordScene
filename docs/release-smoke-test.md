...
- Run `scripts/verify_release_readiness.sh` before manual smoke testing. It
  ...
  leak scanning, privacy manifest validation, privacy surface validation,
  XcodeGen version-marker scanning, macOS tests, iOS generic build, and unsigned
  macOS/iOS Release compiles.
