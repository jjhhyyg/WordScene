...
| DeepSeek live protocol smoke | API | local build host | 1 | PASS | `scripts/run_live_deepseek_translation_smoke.sh` passed at 2026-05-30T02:46:17Z using the ignored local token file. Git commit `41acee0ccd61`. It verified JSON Output with the real DeepSeek API and returned `你好世界` without printing the token. |
...
Generated: 2026-05-30T02:45:35Z
